...
namespace UserModule_JAP_AVSWITCH_FAVOURITE_SWITCHING
{
    public class UserModuleClass_JAP_AVSWITCH_FAVOURITE_SWITCHING : SplusObject
    {
        ...
        private void _46 (  SplusExecutionContext __context__, ushort _48 , CrestronString _49 , CrestronString _50 ) 
            ...
            CrestronString _55;
            CrestronString _56;
            _54  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20000, this );
            _55  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 2000, this );
            _56  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20000, this );
            ...
            StartFileOperations ( ) ; 
            __context__.SourceCodeLine = 27;
            if ( Functions.TestForTrue  ( ( Functions.BoolToInt (FileDelete( _43( __context__ , _50 ) ) != 0))  ) ) 
                {
                __context__.SourceCodeLine = 27;
        ...
        private CrestronString _47 (  SplusExecutionContext __context__, ushort _49 , CrestronString _50 ) 
            ...
            CrestronString _54;
            CrestronString _55;
            _52  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 1000, this );
            _53  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 2000, this );
            _54  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 20000, this );
